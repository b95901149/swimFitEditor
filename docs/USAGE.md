...
![自動合併短趟後](images/04-after-auto-merge.png)
...
專案 `fixtures/demo-swim.fit` 為教學用示範檔（由公開測試向量加工而來），可用來熟悉操作流程。重新產生截圖：
...
示範原始檔來源：[ThomasKuehne/FIT-test-files](https://github.com/ThomasKuehne/FIT-test-files)（Garmin FIT 互通性測試向量）。
